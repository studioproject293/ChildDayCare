...
package com.example.abhinav_rapidbox.childdaycare.rangeSeekBarTwo.rangeseekbar;
...
import com.example.abhinav_rapidbox.childdaycare.rangeSeekBarTwo.util.BitmapUtil;
import com.example.abhinav_rapidbox.childdaycare.rangeSeekBarTwo.util.PixelUtil;
...
public class RangeSeekBar<T extends Number> extends android.support.v7.widget.AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        int thumbNormal = R.drawable.price_bubble;
        int thumbPressed = R.drawable.price_bubble;
        int thumbDisabled = R.drawable.price_bubble;
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        if (showLabels) {
            ...
            canvas.drawText(getResources().getString(R.string.rupee) + " " + minLabel, 0, minMaxHeight, paint);
            canvas.drawText(getResources().getString(R.string.rupee) + " " + maxLabel, getWidth() - minMaxLabelSize, minMaxHeight, paint);
        ...
        rect.top = textOffset + thumbHalfHeight - barHeight / 4;
        rect.bottom = textOffset + thumbHalfHeight + barHeight / 4;
        ...
        if (showTextAboveThumbs && (activateOnDefaultValues || !selectedValuesAreDefault)) {
            ...
            String minText = getResources().getString(R.string.rupee) + " " + valueToString(getSelectedMinValue());
            String maxText = getResources().getString(R.string.rupee) + " " + valueToString(getSelectedMaxValue());
            ...
            if (!singleThumb) {
              ...
              /*  canvas.drawBitmap(BitmapFactory.decodeResource(getResources(),
                        R.drawable.price_bg), minPosition,
                        0, paint);
*/
         ...
         /*   canvas.drawBitmap(BitmapFactory.decodeResource(getResources(),
                    R.drawable.price_bg), maxPosition,
                    0, paint);
*/
